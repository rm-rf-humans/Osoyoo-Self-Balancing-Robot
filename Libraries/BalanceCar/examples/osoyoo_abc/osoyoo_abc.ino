...
double kp = 40, ki = 0.0, kd = 0.7;//需要你修改的参数,角度PD控制
double kp_speed =8, ki_speed = 0.1, kd_speed = 0.0;// 需要你修改的参数，速度PI控制
double kp_turn = 20, ki_turn = 0, kd_turn = 0.6;//旋转PID设定
const double PID_Original[6] = {40, 0.0, 0.7, 8, 0.1, 0.0}; //恢复默认PID参数
//转向PID参数
